...
1. To annotate a human scRNA-seq sets generated by 'FindAllMarkers' function of [Seurat(Butler, A., et al. Nature Biotechnology. 2018)](https://www.nature.com/articles/nbt.4096), and  use the following code
```
  SCSA.py -d whole.db -s seurat -i seurat.input -k All -g Human -o seurat.out
```
2. To list tissue names in the SCSA annotation database, use the following code
```
  SCSA_1.py -i none -d whole.db -l
```
3. To annotate cluster1 of mouse scRNA-seq sets and 
